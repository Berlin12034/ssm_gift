...
/*更新失败，库存数量不足*/
    public static final ResultObj UPDATE_ERROR1 =new ResultObj(SysConstast.CODE_ERROR,SysConstast.UPDATE_ERROR1);
    private Integer code=0;
    private  String msg;
    /*更新失败,数据已经存在*/
    public static final ResultObj UPDATE_CUNERROR = new ResultObj(SysConstast.CODE_ERROR,SysConstast.UPDATE_CUNERROR);
   /*添加成功*/
    ...
    /*添加失败，库存不足*/
    public  static final ResultObj ADD_ERROR1=new ResultObj(SysConstast.CODE_ERROR,SysConstast.ADD_ERROR1);
    /*更新成功*/
