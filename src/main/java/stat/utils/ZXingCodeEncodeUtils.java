...
//		createZXingCodeSaveToDisk("老雷", 400, 400, "D:/laolei.gif", "JPEG");
		InputStream logoStream=ZXingCodeEncodeUtils.class.getClassLoader().getResourceAsStream("16.jpg");
		createZxingCodeUseLogoSaveToDisk("老雷", 400, 400, "D:/", "JPEG", logoStream);
