...
<div class="layui-row layui-col-space10">
    <div class="layui-col-lg6 layui-col-md12">
        ...
        <table class="layui-table mag0" lay-skin="line">
            ...
            <tbody class="hot_news" id="hot_news"></tbody>
        </table>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function getLangDate(){
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${user.name}，"+timeValue+"好！ 欢迎来到礼品店管理系统。当前时间为： "+newDate+"　"+week;
    ...
    layui.use(['form','element','layer','jquery'],function(){
        ...
        //最新文章列表
        $.get("<%=basePath%>/news/loadAllNews.action?page=1&limit=10",function(data){
           /* alert(data.data[0].id);*/
         /*   var hotNewsHtml='';*/
            for(i in data.data){
                var hotNewsHtml;
                 hotNewsHtml= '<tr ondblclick=viewNews('+data.data[i].id+')>'+'<td align="left"><a href="javascript:;">'+data.data[i].title+'</a></td>'
                    +'<td>'+data.data[i].createtime+'</td>'+'</tr>';
                $("#hot_news").append(hotNewsHtml);
            }
          /*  alert(hotNewsHtml);*/
        ...
        //用户数量
        $.get("<%=basePath%>/resources/json/userList.json",function(data){
...
/*要双击触发*/
    function viewNews(id){
        $.get("<%=basePath%>/news/loadNewsById.action",{id:id},function (news) {
            layer.open({
                type:1,
                title:'查看公告',
